...
class Program420
{
    public static void main(String Arg[])
    {
        ...
        obj.InsertIntoTable(4,"Anushaka","Hydrabad",42);
        obj.InsertIntoTable(4,"Mansi","Nashik",53);
        obj.InsertIntoTable(4,"Vedika","Nashik",74);
        obj.InsertIntoTable(4,"Purva","NaviMumbai",78);
        obj.InsertIntoTable(4,"Roshan","Bengaluru",83);
